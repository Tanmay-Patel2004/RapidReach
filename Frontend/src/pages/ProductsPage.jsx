  ...
  const fetchProducts = async () => {
    try {
      ...
      if (result.code === 200) {
        ...
        logger.info('Products fetched successfully', { count: result.data.count });
      } else {
          ...
          >
            {filteredProducts.map((product) => (
              ...
              >
                ...
                >
                  <LowStockIndicator stockQuantity={product.stockQuantity} unit={product.unit} variant="badge" />
                  <Box sx={{ position: 'relative', pt: '100%' }}>
                    <CardMedia
                      component="img"
                      image={product.images[currentImageIndex[product._id]] || 'https://via.placeholder.com/280'}
                      alt={product.name}
                      sx={{ 
                        position: 'absolute',
                        top: 0,
                        ...
                        {product.images.map((_, index) => (
                          <Box
                            ...
                            sx={{
                              ...
                              height: 8,
                              borderRadius: '50%',
                              bgcolor: index === currentImageIndex[product._id] ? 'primary.main' : 'grey.300',
                              cursor: 'pointer'
                            }}
                            onClick={() => setCurrentImageIndex(prev => ({ ...prev, [product._id]: index }))}
                          />
                        ))}
                      </Box>
                    )}
